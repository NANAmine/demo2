...
<div class="admin-content">
  ...
  <div class="am-cf am-padding">
    <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">风险监测点</strong> / <small>point</small></div>
  </div>
      ...
      <div class="am-tab-panel am-fade am-in am-active" id="tab1">
          ...
          <div class="am-g am-margin-top">
            ...
            <div class="am-u-sm-4 am-u-md-4">
            	<select id="source_id">
            		...
            		<c:forEach var="source" items="${sources}" varStatus="s">
            			<c:choose>
            			<c:when test="${source_id==source.id}">  
            ...
            <div class="am-u-sm-1 am-u-md-1">
            	<input type="text" class="am-input-sm" name="weight" id="weight">
            </div>
          </div>
      </div>
      ...
      <div class="am-u-sm-12">
        <form class="am-form">
          <table id="clients_table" class="am-table am-table-striped am-table-hover table-main">
            <thead>
              <tr>
                <th class="table-title" width="45%">风险源</th>
                <th class="table-title" width="45%">监测点</th>
                <th class="table-title" width="10%">权重</th>
              </tr>
          </thead>
          <tbody>
