...
<div class="am-cf admin-main">
  <!-- sidebar start -->
  <jsp:include page="/manage_tree.do" flush="true"/>
  <!-- sidebar end -->
          ...
          <table id="clients_table" class="am-table am-table-striped am-table-hover table-main">
            <thead>
              <tr>
                ...
                <th class="table-title" width="40%">地址</th>
              </tr>
          </thead>
          <tbody>
...
$(function() {
	...
	$("#save_button").click(function() {
		var saveData={"id":$("#id").val(),"name":$("#name").val(),"code":$("#code").val(),"level_code":$("#level_code").val(),"address":$("#address").val(),"status":1};
		$.ajax({
			contentType:"application/json",
		    type : "POST",
		    url : "<%=request.getContextPath()%>/add_company.do",
