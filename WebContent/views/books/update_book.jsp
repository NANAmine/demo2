      	...
      	<input type="hidden" name="id" id="id" value="${books.id}">
		    <div class="am-g doc-am-g">
 				<div class="am-u-sm-3 am-u-md-3 am-u-lg-3">
 					...
 					<input type="text" id="name" value="${books.name}">
		      	</div>
		      	<div class=" am-u-sm-3 am-u-md-3 am-u-lg-3">
		      		<label for="doc-ta-1">编号</label>
 					<input type="text" id="code" value="${books.code}">
		      	</div>
		      	<div class="am-u-sm-3 am-u-md-3 am-u-lg-3">
 					<label for="doc-ta-1">作者</label>
 					<input type="text" id="author" value="${books.author}">
		      	</div>
		      	<div class=" am-u-sm-3 am-u-md-3 am-u-lg-3">
		      		<label for="doc-ta-1">价格</label>
 					<input type="text" id="price" value="<fmt:formatNumber value="${books.price}" pattern="#,#00.00#"/>">
		      	</div>
			</div>
			<div class="am-g doc-am-g">
 				<div class="am-u-sm-3 am-u-md-3 am-u-lg-3">
 					<label for="doc-ta-1">出版时间</label>
 					<input type="text" id="publish_date" value="<fmt:formatDate value="${books.publish_date}" pattern="yyyy-MM-dd"/>" data-am-datepicker readonly required>
 					
		      	</div>
		      	<div class="am-u-sm-6 am-u-md-6 am-u-lg-6 am-u-end">
 					<label for="doc-ta-1">出版社</label>
 					<input type="text" id="publish_company" value="${books.publish_company}">
		      	</div>
			</div>
...
$(function(){ 
  ...
  //保存按钮点击事件
	...
	$("#save_button").click(function() {
		var saveData={"id":$("#id").val(),"name":$("#name").val(),"code":$("#code").val(),"price":price,"publish_company":$("#publish_company").val(),"author":$("#author").val(),"description":$("#description").val()};
		$.ajax({
			contentType:"application/json",
		    type : "POST",
