  ...
  <div class="am-g">
      <div class="am-u-sm-12">
        ...
        <div class="am-u-sm-12 am-u-sm-centered">
          <h2><label for="doc-ta-1">姓名</label>：
 					${member.name}</h2>
 					<p class="am-u-sm-5 am-u-md-5 am-u-lg-5">性别：
 					${member.sex}</p>
 					<p class="am-u-sm-5 am-u-md-5 am-u-lg-5">年龄：
 					${member.age}</p>
 					<p class="am-u-sm-5 am-u-md-5 am-u-lg-5">职位：
 					${member.position.name}</p>
 					<p class="am-u-sm-5 am-u-md-5 am-u-lg-5">入职时间：
 					<fmt:formatDate value="${member.in_date}" pattern="yyyy-MM-dd"/>
 					<p class="am-u-sm-5 am-u-md-5 am-u-lg-5">离职时间：
 					<fmt:formatDate value="${member.out_date}" pattern="yyyy-MM-dd"/>
                	...
                	<%-- <div class="am-u-sm-5 am-u-md-5 am-u-lg-5 am-u-end">
 					<label for="doc-ta-1">姓名</label>：
 					${member.name}
		      	</div>
 				<div class="am-u-sm-5 am-u-md-5 am-u-lg-5">
 					<label for="doc-ta-1">性别</label>：
 					${member.sex}
		      	</div>
		      	<div class="am-u-sm-5 am-u-md-5 am-u-lg-5">
 					<label for="doc-ta-1">年龄</label>：
 					${member.age}
		      	</div>
		      	<div class="am-u-sm-5 am-u-md-5 am-u-lg-5">
 					<label for="doc-ta-1">职位</label>：
 					${member.position.name}
		      	</div>
		      	<div class="am-u-sm-5 am-u-md-5 am-u-lg-5">
 					<label for="doc-ta-1">入职时间</label>：
 					<fmt:formatDate value="${member.in_date}" pattern="yyyy-MM-dd"/>
		      	</div>
		      	<div class="am-u-sm-5 am-u-md-5 am-u-lg-5">
 					<label for="doc-ta-1">离职时间</label>：
 					<fmt:formatDate value="${member.out_date}" pattern="yyyy-MM-dd"/>
		      	</div>
			...
			<div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
			 <h2><label for="doc-ta-1" >人员简介:</label></h2>
		      <p rows="15" id="description" readonly="readonly">${member.remark}</p>
		 </div>
			<%-- <div class="am-form-group">
		      <label for="doc-ta-1">人物简介</label>
		      <textarea class="" rows="15" id="description" readonly="readonly">${member.remark}</textarea>
		    </div> --%>
		  </div>
		</form>
...
$(function(){ 
	...
	$("#back_button").click(function() {
		window.location.href="search_member_list.do";
	});
});
</script>
</body>
