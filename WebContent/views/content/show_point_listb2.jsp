      ...
      <div class="am-tab-panel am-fade am-in am-active" id="tab1">
          ...
          <div class="am-g am-margin-top">
           <table class="am-table table-main" >
            ...
            <th class="am-u-sm-2 am-u-md-2">
            	<select id="source_id" name="source_id" class="am-fr">
            		<option value="0">单警装备</option>
            		<option value="1">车辆</option>
            		<option value="2">枪支弹药</option>
            	</select>
            </th>
            <th class="am-u-sm-6 am-u-md-6 am-text-right">
            </th>
            </tr>
    </table>
  ...
  <table id="clients_table" class="am-table am-table-striped am-table-hover table-main">
            <thead>
              <tr>
                ...
                <th class="table-title" width="10%">名称</th>
                <th class="table-title" width="10%">系统编号</th>
                <th class="table-title" width="15%">购买时间</th>
                <th class="table-title" width="15%">价格</th>
                <th class="table-title" width="15%">状态</th>
                <th class="table-title" width="15%">备注</th>
              </tr>
          </thead>
           <tr>
                <th class="table-title"width="10%">01</th>
                <th class="table-title" width="10%">客车</th>
                <th class="table-title" width="10%">金杯</th>
                <th class="table-title" width="10%">F-0011</th>
                <th class="table-title" width="15%">2016-10-03</th>
                <th class="table-title" width="15%">80000.00</th>
                <th class="table-title" width="15%">空闲</th>
               ...
               <tr>
                ...
                <th class="table-title" width="10%">A-0001</th>
                <th class="table-title" width="15%">2016-10-18</th>
                <th class="table-title" width="15%">5000.00</th>
                <th class="table-title" width="15%">占用</th>
                <th class="table-title" width="15%">----------</th>
              </tr>
               <tr>
