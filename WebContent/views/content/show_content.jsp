...
<div class="admin-content">
  ...
  <div class="am-cf am-padding">
    <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">事件查看</strong> / <small>update</small></div>
  </div>
  <div class="am-g">
			...
			<div class="am-g doc-am-g">
 				<div class="am-u-sm-9 am-u-md-9 am-u-lg-9">
		      	...
		      	<div class="am-u-sm-3 am-u-md-3 am-u-lg-3 am-u-end">
 					...
 					<fmt:formatDate value="${content.create_date}" pattern="yyyy-MM-dd"/>
		      	</div>
			</div>
			<div class="am-form-group">
		      <label for="doc-ta-1">内容</label>
		      <textarea class="" rows="15" id="description" readonly="readonly">${content.description}</textarea>
		    </div>
...
$(function(){ 
	...
	$("#back_button").click(function() {
		window.location.href="show_content_list.do";
	});
});
</script>
</body>
