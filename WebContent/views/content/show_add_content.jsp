...
<div class="admin-content">
  ...
  <div class="am-cf am-padding">
    <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">事件录入</strong> / <small>insert</small></div>
  </div>
  <div class="am-g">
      	...
      	<input type="hidden" name="id" id="id" value="0">
		    <div class="am-g doc-am-g">
 				<div class="am-u-sm-3 am-u-md-3 am-u-lg-3">
		      	...
		      	<div id="sub_class_div" class=" am-u-sm-3 am-u-md-3 am-u-lg-3 am-u-end">
			...
			<div class="am-g doc-am-g">
 				<div class="am-u-sm-9 am-u-md-9 am-u-lg-9">
		      	...
		      	<div class="am-u-sm-3 am-u-md-3 am-u-lg-3 am-u-end">
 					<label for="doc-ta-1">时间</label>
 					<input type="text" id="create_time" data-am-datepicker readonly required>
		      	</div>
			</div>
			<div class="am-form-group">
		      <label for="doc-ta-1">内容</label>
		      <textarea class="" rows="15" id="description"></textarea>
		    </div>
...
$(function(){ 
  ...
  //保存按钮点击事件
	...
	$("#save_button").click(function() {
		var saveData={"id":$("#id").val(),"title":$("#title").val(),"description":$("#description").val()};
		$.ajax({
			contentType:"application/json",
		    type : "POST",
		    url : "<%=request.getContextPath()%>/save_content.do?class_id="+$("#class_id").val()+"&create_time="+$("#create_time").val(),
