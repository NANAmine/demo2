    ...
    <div class="am-tabs-bd">
      <div class="am-tab-panel am-fade am-in am-active" id="tab1">
         ...
         <table class="am-table table-main" >
            <tr>
            <th class="am-u-sm-1 am-u-md-1 am-text-right">
              	科室：
            </th>
            <th class="am-u-sm-2 am-u-md-2">
            	<select id="source_id" name="source_id" class="am-fr">
            		<option value="0">科室1</option>
            		<option value="1">科室2</option>
            	</select>
            </th>
            <th class="am-u-sm-1 am-u-md-1 am-text-right">
              	状态：
            ...
            <th class="am-u-sm-2 am-u-md-2">
            	<select id="source_id" name="source_id" class="am-fr">
            		<option value="0">在职人员情况</option>
            		<option value="1">离职人员情况</option>
            		<option value="1">外聘专家情况</option>
            		<option value="1">校外导师情况</option>
            	</select>
            </th>
            <th class="am-u-sm-6 am-u-md-6">
  ...
  <table id="clients_table" class="am-table am-table-striped am-table-hover table-main">
            <thead>
              <tr>
                ...
                <th class="table-title" width="10%">姓名</th>
                <th class="table-title" width="10%">性别</th>
                <th class="table-title" width="10%">年龄</th>
                <th class="table-title" width="15%">职位</th>
           ...
           <tr>
                ...
                <th class="table-title" width="10%">张三</th>
                <th class="table-title" width="10%">男</th>
                <th class="table-title" width="10%">23</th>
                <th class="table-title" width="15%">xx</th>
                <th class="table-title" width="15%">在职</th>
                <th class="table-title" width="15%">2017-08-13</th>
                <th class="table-title" width="15%">----------</th>
              </tr>
               <tr>
                <th class="table-title"width="10%">02</th>
                <th class="table-title" width="10%">李四</th>
                <th class="table-title" width="10%">男</th>
                <th class="table-title" width="10%">24</th>
                <th class="table-title" width="15%">xx</th>
                <th class="table-title" width="15%">在职</th>
                <th class="table-title" width="15%">2018-02-23</th>
                <th class="table-title" width="15%">----------</th>
              </tr>
               <tr>
                <th class="table-title"width="10%">03</th>
                <th class="table-title" width="10%">王五</th>
                <th class="table-title" width="10%">男</th>
                <th class="table-title" width="10%">23</th>
                <th class="table-title" width="15%">xx</th>
                <th class="table-title" width="15%">在职</th>
               ...
               <tr>
                <th class="table-title"width="10%">04</th>
                <th class="table-title" width="10%">李三</th>
                <th class="table-title" width="10%">男</th>
                <th class="table-title" width="10%">23</th>
                <th class="table-title" width="15%">xx</th>
                <th class="table-title" width="15%">在职</th>
               ...
               <tr>
                <th class="table-title"width="10%">05</th>
                <th class="table-title" width="10%">张二</th>
                <th class="table-title" width="10%">男</th>
                <th class="table-title" width="10%">23</th>
                <th class="table-title" width="15%">xx</th>
                <th class="table-title" width="15%">在职</th>
